...
var (
	...
	talkgroupToChannel = map[int64][]SlackChannelID{
		2100:                          []SlackChannelID{BERKELEY, BERKELEY_FIRE_SECONDARY},
		2105:                          []SlackChannelID{BERKELEY, BERKELEY_FIRE_SECONDARY},
		2106:                          []SlackChannelID{BERKELEY, BERKELEY_FIRE_SECONDARY},
		2107:                          []SlackChannelID{BERKELEY, BERKELEY_FIRE_SECONDARY},
		2108:                          []SlackChannelID{BERKELEY, BERKELEY_FIRE_SECONDARY},
		2109:                          []SlackChannelID{BERKELEY, BERKELEY_FIRE_SECONDARY},
		2110:                          []SlackChannelID{BERKELEY, BERKELEY_FIRE_SECONDARY},
		2111:                          []SlackChannelID{BERKELEY, BERKELEY_FIRE_SECONDARY},
		2112:                          []SlackChannelID{BERKELEY, BERKELEY_FIRE_SECONDARY},
